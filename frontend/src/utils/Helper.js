import ADD_STORY_IMG from "../assets/images/getstarted.svg"
import NO_SEARCH_DATA_IMG from "../assets/images/no-data.png"
...
export const getEmptyCardMessage = (filterType) => {
    switch (filterType) {
        ...
        default:
            return `Start creating your first travel Story! Click the 'Add' button to start noting down your travel experiences`;
    }
}
