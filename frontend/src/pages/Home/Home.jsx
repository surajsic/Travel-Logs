...
const Home = () => {
  ...
  const getAllTravelStories = async () => {
    try {
      const response = await axiosInstance.get("http://localhost:3000/get-all-stories")
  ...
  const updateIsFavourite = async (storyData) => {
    ...
    try {
      const response = await axiosInstance.put("http://localhost:3000/update-isFav/" + storyId, {
  ...
  const deleteTravelStory = async (data) =>{
    ...
    try {
      const response = await axiosInstance.delete("http://localhost:3000/delete-story/" + storyId)
  ...
  //Handle Filter Travel Search Story by Date Range
  const filterStoriesByDate = async (day)=>{
    try {
      ...
      if (startDate && endDate) {
        const response = await axiosInstance.get("http://localhost:3000/travel-stories/filter", {
          params:{
            startDate, 
            endDate
          }
          ...
          <div className='w-[350px]'>
            ...
            <Modal 
              ...
              className="model-box" >
                ...
                <AddEditTravelStory storyInfo={openAddEditModal.data} 
