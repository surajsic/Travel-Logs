...
const AddEditTravelStory = ({ storyInfo, type, onClose, getAllTravelStories }) => {
    ...
    const addNewTravelStory = async () =>{
        try {
            ...
            const response = await axiosInstance.post("http://localhost:3000/add-travel-story", {
                title,
                story, 
                imageUrl: imageUrl || "",
                visitedLocation,
    ...
    const updateTravelStory = async ()=>{
        ...
        try {
            ...
            const response = await axiosInstance.put("http://localhost:3000/edit-story/"+ storyId, postData)
    ...
    //Delete story image & update the story 
    const handleDeleteStoryImg = async ()=>{
        const deleteImgRes = await axiosInstance.delete("http://localhost:3000/delete-image",{
            params:{
                imageUrl: storyInfo.imageUrl
            }
        })
